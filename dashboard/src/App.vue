<template>
  <div
    dir="rtl"
    class="flex h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white font-sans transition-colors duration-300"
  >
    ...
    >
      <!-- Sidebar Header -->
      <div
        class="flex items-center justify-between py-6 border-b border-gray-700"
      >
        <h1
          v-if="openSidebar"
