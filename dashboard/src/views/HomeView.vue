<template>
  <div class="p-4 sm:p-6 space-y-8">
    <!-- عنوان الصفحة -->
    <h1
      class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 dark:text-white"
    >
      الرئيسية
    </h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      ...
      >
        <div>
          <h2
            class="text-base sm:text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-300"
          >
            {{ card.title }}
          </h2>
          <p
            class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-2"
          >
            {{ card.value }}
          </p>
        </div>
    ...
    <!-- قسم الرسم البياني -->
    <div
      class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-lg transition-colors duration-300"
    >
      <h2
        class="text-base sm:text-lg md:text-xl font-semibold text-gray-800 dark:text-white mb-4"
      >
