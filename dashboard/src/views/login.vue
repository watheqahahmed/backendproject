<template>
  <div class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
      <h2 class="text-2xl font-bold mb-6 text-gray-700 dark:text-gray-200">تسجيل الدخول</h2>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">
        لا تملك حساب؟ <router-link to="/signup" class="text-indigo-500 hover:underline">إنشاء حساب</router-link>
      </p>
...
const API_URL = 'http://localhost:8080/backendproject/backend/api/index.php?request=login'
